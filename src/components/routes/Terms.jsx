      ...
      <div style={sStyles.flexColumnCenter}>
        <TextSection>
          ...
          <BodyText className={textPaddingBottom}>
            ...
            accessing or using our App, you agree to be bound by these Terms. If you do not agree
          ...
          <BodyText className={textPaddingBottom}>
            To use the App, you must create an account. You are responsible for providing accurate
            and up-to-date information during the registration process. You must keep your account
          ...
          <BodyText className={textPaddingBottom}>
            You agree to use the App in compliance with all applicable laws and regulations. You
            must not engage in any activities that may:
            <OrderedList className={letterList}>
              <li>
                Violate the rights of others or infringe upon any intellectual property or
                proprietary rights;
              </li>
          ...
          <BodyText className={textPaddingBottom}>
            ...
            software, designs, and content created by us, are the exclusive property of the
            App&apos;s owner or its licensors. You may not use, reproduce, distribute, or modify any
            of these materials without obtaining explicit permission from the respective owner.
          </BodyText>
          <SmallHeading className={textPaddingBottom}>3.3 Prohibited Content</SmallHeading>
          <BodyText className={textPaddingBottom}>
            You agree not to post content that is illegal, obscene, defamatory, threatening,
            invasive of privacy, infringing on intellectual property rights, or otherwise
            objectionable.
          </BodyText>
          ...
          <BodyText className={textPaddingBottom}>
            ...
            responsibly. Our Privacy Policy, incorporated by reference, explains how we collect,
            use, and safeguard your information. By using the App, you consent to our privacy
            practices as outlined in the Privacy Policy.
          </BodyText>
          <SmallHeading className={textPaddingBottom}>4.2 Data Collection</SmallHeading>
          <BodyText className={textPaddingBottom}>
            We may collect certain information from you when you use the App, such as your name,
            email address, profile information, and device information. We may also collect and
            store content you create or provide while using the App, such as photos, videos, and
            messages.
          </BodyText>
          ...
          <Heading3 className={h3PaddingBottom}>
          ...
          <BodyText className={textPaddingBottom}>
            TO THE FULLEST EXTENT PERMITTED BY LAW, IN NO EVENT WILL WE BE LIABLE TO YOU OR ANY
            THIRD PARTY FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES
            ARISING OUT OF OR RELATED TO YOUR USE OF THE APP, INCLUDING BUT NOT LIMITED TO LOSS OF
            PROFITS, LOSS OF DATA, OR LOSS OF REPUTATION. OUR TOTAL LIABILITY ARISING OUT OF OR
            RELATED TO THESE TERMS SHALL NOT EXCEED THE AMOUNT YOU HAVE PAID US, IF ANY, IN THE PAST
            SIX MONTHS.
          </BodyText>
