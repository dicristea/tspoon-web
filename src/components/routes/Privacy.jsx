    ...
    <>
      ...
      <div style={sStyles.flexColumnCenter}>
        <TextSection>
          ...
          <BodyText className={textPaddingBottom}>
            When you use Tspoon, you&apos;ll share information with us so we can enhance your
            personal and community experience on the platform. We are upfront and transparent about
            exactly what information we collect, how we use, where we use it, whom we share it with
            and how you can tailor your privacy choices to ensure that you are comfortable with the
            information you are sharing when using our platform.
          </BodyText>
          <BodyText className={textPaddingBottom}>
            We&apos;ve done our best to create a privacy policy that is clear and easy to
            understand. If you have any questions or concerns regarding our privacy policy, do not
          ...
          <BodyText className={textPaddingBottom}>
            When you use Tspoon, we collect information that you provide to us. When you first set
            up an account with Tspoon, we collect a few important details about you: your name,
            username, password, email address, phone number, date of birth, profile picture, and
            location. Some of these pieces of information will be publicly available, such as your
            profile picture and username.
          </BodyText>
          <BodyText className={textPaddingBottom}>
            You will also provide us with data that you share on Tspoon, such as Recipes and Tips.
            We do not prohibit other users from screenshotting or saving in any form the Recipes and
          ...
          <BodyText className={textPaddingBottom}>
            Below is a more detailed list of what kind of data we collect from your usage of the
            App:
          </BodyText>
          <List className={showDots}>
            ...
            <li>
              Content: We collect the content you create and share on Tspoon, such as custom
              recipes, and the information on the content you create, such as the bio, interactions,
              and impressions.
            </li>
            <li>
              Device: We collect information from and about the devices you use to access Tspoon.
            ...
            <li>
              Camera and Photos: We request permission to access your device&apos;s camera and
              photos in order to collect images and allow you to access your pictures to upload to
              Tspoon.
            </li>
            <li>
          ...
          <BodyText className={textPaddingBottom}>
            ...
            <List className={showDots}>
              ...
              <li>
                Advertisers, app developers, publishers, and third parties may share information
                with us as well. We may use this information in ways to better help and measure the
          ...
          <BodyText className={textPaddingBottom}>
            Our platform may make use of content and integration from third-parties including but
            not limited to meal delivery services, grocery delivery services, and other food
            technology services. Tspoon is not responsible for how those third parties collect or
            use their information. Should there be a problem that persists, please consult the
            respective service&apos;s terms of service and privacy policies.
          </BodyText>
          <BodyText className={textPaddingBottom}>
            We urge our users to review the privacy policies and terms of service of every
            third-party service that you use, especially ones that are used on Tspoon&apos;s
            platform. Tspoon cannot speak for other services or how they choose to use the
            information they process.
          </BodyText>
          <Heading4 className={h4PaddingBottom}>Deleting Your Information</Heading4>
          <BodyText className={textPaddingBottom}>
            User account information can be deleted from the settings page. To delete your page,
            click the settings icon on the profile page, and navigate to the accounts page. From
            here, scroll to the bottom and tap on “Delete Account”. The App will prompt your
            confirmation, and after that you account and its information will be deleted.
          </BodyText>
          ...
          <List className={showDots}>
            <li>
              <b>Right to know what personal information we collect.</b> You have the right to
              request details on the information we&apos;ve collected about you. We provide these
              details above, however, you can also get this information by contacting us.
            </li>
            <li>
              <b>Right to know who we share your data with.</b> We share your information with
              others for legitimate business purposes. For example, we use service providers to
              store and hose your data. We also share data that you have given us permission to
              share with ad providers to better personalize those ads.
            </li>
            <li>
            ...
            <li>
              ...
              typically respond within 45 days, or request another 45 days in difficult cases. You
              may always contact us if you need a more timely response.
            </li>
            <li>
              <b>Non-discrimination.</b> We will never punish or discriminate in any form against
              you when you exercise these privacy rights. We encourage you to review you privacy
              settings and reach out with any questions or concerns. We want to help in any way to
              make you as comfortable as possible with our processes.
            </li>
          </List>
          <Heading3 className={h3PaddingBottom}>Revisions</Heading3>
          <BodyText className={textPaddingBottom}>
            Tspoon reserves the right to update or revise this privacy policy in the future. All
            users that are on our platform will be notified as soon as a change is implemented. We
            may let you know through the revised date below, or through your personal account.
          </BodyText>
